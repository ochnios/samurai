...
public class AssistantFactory {
    ...
    private OpenAiEmbeddingModel createOpenAiEmbeddingModel(OpenAiApi openAiApi, AssistantConfigDto config) {
    ...
    private QdrantVectorStore createQdrantVectorStore(OpenAiEmbeddingModel embeddingClient, String collectionName) {
