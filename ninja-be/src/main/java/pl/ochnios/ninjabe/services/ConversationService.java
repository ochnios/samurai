...
public class ConversationService {
    ...
    public ConversationDto getConversation(UUID userId, UUID assistantId, UUID conversationId) {
        var conversation = conversationRepository
                .findConversationByUserIdAndAssistantIdAndIdAndDeleted(userId, assistantId, conversationId, false);
    ...
    protected Conversation findOrCreateConversation(UUID userId, UUID assistantId, UUID conversationId) {
