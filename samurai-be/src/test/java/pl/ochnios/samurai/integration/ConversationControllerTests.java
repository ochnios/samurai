...
public class ConversationControllerTests {
    ...
    class Get {
        ...
        public void get_summaries_200() throws Exception {
            var requestBuilder = MockMvcRequestBuilders.get(CONVERSATIONS_URI + "/summaries");
        ...
        public void get_summaries_2nd_page_200() throws Exception {
            var user = userCrudRepository.findByUsername("user");
            ...
            var pageRequest = new PageRequestDto(1, 1, List.of("summary"), List.of("asc"));
            var requestBuilder =
        ...
        public void get_summaries_2nd_page_empty_200() throws Exception {
            var pageRequest = new PageRequestDto(1, 1, null, null);
            var requestBuilder =
                    MockMvcRequestBuilders.get(CONVERSATIONS_URI + "/summaries").params(asParamsMap(pageRequest));
            mockMvc.perform(requestBuilder)
                    .andExpect(status().isOk())
        ...
        public void get_by_id_200() throws Exception {
            var requestBuilder = MockMvcRequestBuilders.get(CONVERSATIONS_URI + "/" + conversationId);
            mockMvc.perform(requestBuilder)
                    .andExpect(status().isOk())
        ...
        public void get_by_id_404() throws Exception {
            ...
            var requestBuilder = MockMvcRequestBuilders.get(CONVERSATIONS_URI + "/" + notExistingId);
    ...
    class Patch {
        ...
        public void patch_conversation_200() throws Exception {
            var patch = new JsonPatchDto("replace", "/summary", "New summary");
            var requestBuilder = MockMvcRequestBuilders.patch(CONVERSATIONS_URI + "/" + conversationId)
        ...
        public void patch_conversation_summary_blank_400() throws Exception {
            var patch = new JsonPatchDto("replace", "/summary", "   ");
        ...
        public void patch_conversation_summary_null_400() throws Exception {
            var patch = new JsonPatchDto("replace", "/summary", null);
            test_patch_validation(patch, "summary must not be blank or null");
        }

        @Test
        public void patch_conversation_summary_too_short_400() throws Exception {
            var patch = new JsonPatchDto("replace", "/summary", "xx");
    ...
    class Delete {
        ...
        public void delete_conversation_204() throws Exception {
            var requestBuilder = MockMvcRequestBuilders.delete(CONVERSATIONS_URI + "/" + conversationId);
            mockMvc.perform(requestBuilder)
        ...
        public void delete_conversation_404() throws Exception {
            var notExistingId = UUID.nameUUIDFromBytes("not existing".getBytes());
            var requestBuilder = MockMvcRequestBuilders.delete(CONVERSATIONS_URI + "/" + notExistingId);
            mockMvc.perform(requestBuilder)
    ...
    class SearchForbidden {
        ...
        public void get_conversations_403() throws Exception {
            var requestBuilder = MockMvcRequestBuilders.get(CONVERSATIONS_URI);
            mockMvc.perform(requestBuilder)
    ...
    class Search {
        ...
        public void search_summary_filter() throws Exception {
            var searchCriteria = ConversationCriteria.builder().summary("user").build();
            var requestBuilder = MockMvcRequestBuilders.get(CONVERSATIONS_URI).params(asParamsMap(searchCriteria));
            mockMvc.perform(requestBuilder)
                    .andExpect(status().isOk())
                    .andExpect(jsonPath("$.pageNumber", is(0)))
                    .andExpect(jsonPath("$.totalElements", is(1)))
        ...
        public void search_by_user_lastname() throws Exception {
            var searchCriteria = ConversationCriteria.builder()
        ...
        public void search_by_deleted() throws Exception {
            ...
            var searchCriteria = ConversationCriteria.builder().deleted(true).build();
            var requestBuilder = MockMvcRequestBuilders.get(CONVERSATIONS_URI).params(asParamsMap(searchCriteria));
            mockMvc.perform(requestBuilder)
                    .andExpect(status().isOk())
                    .andExpect(jsonPath("$.pageNumber", is(0)))
        ...
        private Conversation createConversation(String summary, String username) {
            var conversationId = UUID.nameUUIDFromBytes(summary.getBytes());
            var user = userCrudRepository.findByUsername(username);
